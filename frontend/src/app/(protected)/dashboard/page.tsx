...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="EV Charging Operations Dashboard"
      subtitle="One merged ev charging operations view for Records, Workspaces, Requests, Cases, Schedules, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared ev charging operations jobs into one surface. Records, Workspaces, Requests, Cases, Schedules, Resources, documents, audit, and AI are presented as platform features.</div>
