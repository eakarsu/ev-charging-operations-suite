...
export const sourceSystems = [
  { name: 'AIEVChargingOperationsAssistant', ownership: 'Records source capabilities and workflows', coverage: ['Records', 'Workspaces', 'Requests'] },
  { name: 'AIEVChargingOperationsOperations', ownership: 'Workspaces source capabilities and workflows', coverage: ['Cases', 'Schedules', 'Resources'] },
  { name: 'AIEVChargingOperationsAnalytics', ownership: 'Requests source capabilities and workflows', coverage: ['Approvals', 'Exceptions', 'Compliance'] },
  { name: 'AIEVChargingOperationsWorkflow', ownership: 'Cases source capabilities and workflows', coverage: ['Analytics', 'Forecasts', 'Reports'] },
];
