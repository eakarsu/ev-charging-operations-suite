...
PORT="${PORT:-18090}"
DB_NAME="${PGDATABASE:-ev_charging_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      EV Charging Operations Suite"
echo "======================================="
echo
...
echo "Starting ev charging operations suite frontend on http://localhost:$PORT"
echo "Login: admin@ev-charging-operations.local / admin123"
